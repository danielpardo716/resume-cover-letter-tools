...
\begin{document}
    ...
    \begin{header}
        \fontsize{25 pt}{25 pt}\selectfont Daniel Pardo
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{mailto:dpardo25@proton.me}{dpardo25@proton.me}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{tel:+1-716-263-2250}{(716) 263-3350}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://linkedin.com/in/danielpardo716}{linkedin.com/in/danielpardo716}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://github.com/danielpardo716}{github.com/danielpardo716}}%
    \end{header}

    \vspace{5 pt - 0.3 cm}

    \section{Education}
        \begin{twocolentry}{August 2018 - May 2022}
            \textbf{SUNY University at Buffalo}, Bachelors of Science, Electrical Engineering
        \end{twocolentry}
        \vspace{0.10 cm}
        \begin{onecolentry}
            \begin{highlights}
                \item GPA: 3.9
                \item Treasurer, UBRobotics
                \item Scholar, University Honors College
            \end{highlights}
        \end{onecolentry}
