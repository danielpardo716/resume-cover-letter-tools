...
\usepackage{plex-sans}        % Change this to use any font, but keep it simple
...
\newcommand{\subtitle}[1]{\large\itshape #1}
...
\cvtitle{John Miller} \\[0.5ex]
\subtitle{Data Analyst} % Add your subtitle here
\normalsize
